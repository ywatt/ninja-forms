...
<script id="tmpl-nf-builder-loading" type="text/template">
    <div class="nf-loading-container">
        <div class="nf-loading-wrap">
            <div id="nf-logo"></div>
            <div class="nf-loading-text">Loading</div>
                <svg class="icon-loading" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                    <path opacity=".25" d="M16 0 A16 16 0 0 0 16 32 A16 16 0 0 0 16 0 M16 4 A12 12 0 0 1 16 28 A12 12 0 0 1 16 4" fill="#424242" stroke-width="1" />
                        <path d="M16 0 A16 16 0 0 1 32 16 L28 16 A12 12 0 0 0 16 4z" fill="#1EA9EA" stroke-width="1" >
