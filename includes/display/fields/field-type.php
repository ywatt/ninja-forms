...
function ninja_forms_register_display_field_type(){
	add_action('ninja_forms_display_after_opening_field_wrap', 'ninja_forms_display_field_type', 10, 3);
}

function ninja_forms_display_field_type( $field_id, $data, $form_id ){
	...
	$field_type = apply_filters( 'ninja_forms_display_field_type', $field_type, $field_id, $form_id );
?>
