...
function ninja_forms_admin_js(){
	...
	wp_localize_script( 'ninja-forms-admin', 'ninja_forms_settings', array( 'nf_ajax_nonce' => wp_create_nonce( 'nf_ajax'), 'datepicker_args' => apply_filters( 'admin_submissions_datepicker_args', array( 'dateFormat' => $date_format) ) ) );
